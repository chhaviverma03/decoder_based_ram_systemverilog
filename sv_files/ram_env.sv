...
class ram_env;
        ...
        ram_ref_model rm;
        ram_scoreboard sb;
        //mailbox created here for wiring only, never accessed after build()
        ...
        function new(
          ...
          //CREATING ACTUAL MAILBOX OBJECT
          wr_mbx      = new();
          rd_mbx      = new();
          wr_done_mbx = new();
          rm_wr_mbx   = new();
        ...
        //instance creation => creating actual objects of the classes that make up the environment.
        function void build();
          gen    = new(wr_mbx, rd_mbx, wr_done_mbx);
          wr_drv = new(wr_vif, wr_mbx, wr_done_mbx);
          rd_drv = new(rd_vif, rd_mbx);
